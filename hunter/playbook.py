...
PLAYBOOKS: tuple[Playbook, ...] = (
    Playbook(
        ...
        phrases=("automate", "automation", "zapier", "make.com", "n8n", "google sheet",
                 "google sheets", "connect my", "sync data", "workflow", "airtable",
    ...
    Playbook(
        ...
        phrases=("bug fix", "fix my", "react app", "next js", "nextjs", "front end",
