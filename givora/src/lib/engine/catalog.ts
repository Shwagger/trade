...
export type Archetype = {
  ...
  digital?: boolean;
  /**
   * Pictogramme de la carte. À défaut on prend celui de la catégorie —
   * mais une catégorie est trop large pour beaucoup d'articles : dans
   * « gourmet », un kit de cafés méritait mieux qu'un fromage.
   */
  glyph?: string;
  note: string;
};
